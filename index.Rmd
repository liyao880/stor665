...
|Mar. 1| Constant Coefficient of Variation Models I|Lab 4: Overdispersion and Zero-Inflation|
|Mar. 6| Constant Coefficient of Variation Models II||
|Mar. 8| Mid-term Exam ||
|Mar. 13| Spring Break||
|Mar. 15| Spring Break||
|Mar. 20| Quasi-likelihood and GAM |Lab 5: Boostrap and GAM|
|Mar. 22| Overview of Machine Learning||
|Mar. 27| Linear Regression and Classification|Lab 6: Python and Pytorch|
|Mar. 29| Optimization in ML||
|Apr. 3| Kernel Methods||
|Apr. 5| Tree-based Methods||
|Apr. 10| Multilayer Perceptron||
|Apr. 12| Convolutional Neural Networks| Lab 7: DNN Training|
|Apr. 17| Recurrent Neural Networks||
|Apr. 19| GRU and LSTM ||
|Apr. 24| NLP Pre-training||
|Apr. 26| Generative Models||
